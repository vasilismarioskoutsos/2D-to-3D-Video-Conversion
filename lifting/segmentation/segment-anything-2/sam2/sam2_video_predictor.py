...
from sam2.utils.misc import concat_points, fill_holes_in_mask_scores, load_video_frames, load_numpy_frames
...
class SAM2VideoPredictor(SAM2Base):
    ...
    def init_state(
        ...
        if is_numpy_frames:
            images = load_numpy_frames(
                frames=frames,
                image_size=self.image_size,
                offload_video_to_cpu=offload_video_to_cpu,
                async_loading_frames=async_loading_frames,
                compute_device=compute_device,
                is_numpy_frames=is_numpy_frames
            )

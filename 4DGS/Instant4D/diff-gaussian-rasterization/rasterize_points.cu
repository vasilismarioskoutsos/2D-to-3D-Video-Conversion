...
RasterizeGaussiansCUDA(
	...
	const torch::Tensor& motion_probabilities,
	...
	const bool debug)
{
  ...
  if(P != 0)
  {
	  ...
	  rendered = CudaRasterizer::Rasterizer::forward(
		...
		motion_probabilities.contiguous().data<float>(),
...
//   torch::Tensor dL_dm = torch::zeros({P, 1}, means3D.options());
...
// add a motion probability version for rasterization

// std::tuple<int, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
// RasterizeGaussiansCUDA_motion(
// 	const torch::Tensor& background,
// 	const torch::Tensor& means3D,
//     const torch::Tensor& colors,
// 	const torch::Tensor& flows,

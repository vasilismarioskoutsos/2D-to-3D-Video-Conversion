...
# from . import _C
import os, sys
_cache_path = r"C:\Users\MIRANET-Workstation\AppData\Local\torch_extensions\torch_extensions\Cache\py311_cu121\diff_gaussian_rasterization"
if _cache_path not in sys.path:
    sys.path.insert(0, _cache_path)
import importlib
_C = importlib.import_module('diff_gaussian_rasterization')
